...
h2=(green). Use only one level of indentation per method.
...
h2=(green). Don't use the 'else' keyword
...
h2=(green). Wrap all primitives and strings
...
h2=(green). Use only one dot per line
...
h2=(green). Don’t abbreviate names
...
h2=(green). No more than 2 instance variables per class
...
h2=(green). Use first-class collections
...
h2=(green). Don’t use _setters_ or _getters_
